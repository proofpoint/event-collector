...
import static com.proofpoint.event.combiner.S3StorageHelper.getS3Bucket;
import static com.proofpoint.event.combiner.S3StorageHelper.getS3ObjectKey;
import static com.proofpoint.event.combiner.S3StorageHelper.updateStoredObject;
        ...
        implements StorageSystem
{
    ...
    {
        log.info("getObjectDetails: %s", target);
