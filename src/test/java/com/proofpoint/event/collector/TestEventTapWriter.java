...
public class TestEventTapWriter
{
    ...
    {
        Map<String, String> properties = tapA1a.getProperties();
        FlowKey flowKey = new FlowKey(properties.get(EVENT_TYPE_PROPERTY_NAME), properties.get(FLOW_ID_PROPERTY_NAME));
        String uri = properties.get(HTTP_PROPERTY_NAME);
    ...
    {
        Map<String, String> properties = tapA1.getProperties();
        FlowKey flowKey = new FlowKey(properties.get(EVENT_TYPE_PROPERTY_NAME), properties.get(FLOW_ID_PROPERTY_NAME));

        String uriA = tapA1a.getProperties().get(HTTP_PROPERTY_NAME);
        String uriB = tapA1b.getProperties().get(HTTP_PROPERTY_NAME);
    ...
    public void testStaticAndDynamicAnnouncementForSameFlowIdDifferentEventType()
    {
        ...
        updateThenRefreshFlowsThenCheck(ImmutableList.of(tapB1), ImmutableList.of(tapA1a, tapB1));
